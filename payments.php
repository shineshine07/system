            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <span class="float:right"><a class="btn btn-danger btn-block btn-sm col-sm-2 float-right"
...
while ($payment = $payments_query->fetch_assoc()):
    ...
    $student_query = $conn->query("SELECT s.name as sname, s.id_no, s.course, s.level, p.total_amount FROM student s INNER JOIN payments p ON s.id = p.student_id WHERE s.id = $student_id");
...
?>
                                <tr>
                                    ...
                                    <td>
                                        <p><b><?php echo $student['or_number'] ?></b></p>
                                    </td>
                                    <td>
                                    ...
                                    <button class="btn btn-sm btn-outline-primary view_payment" type="button" data-id="<?php echo $payment['id'] ?>">View</button>
                                    <button class="btn btn-sm btn-outline-warning archive_payment" type="button" data-id="<?php echo $payment['id'] ?>" data-action="archive_payment">Archive</button>
                                </td>
                                </tr>
                                <?php endwhile; ?>
