                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <span class="float:right">
                            <a class="btn btn-danger btn-block btn-sm col-sm-2 float-right" href="javascript:void(0)" id="new_course">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                             <!-- Add the edit button -->
											 <button class="btn btn-sm btn-outline-dark edit_fees" type="button" data-id="<?php echo $row['id'] ?>" data-description="<?php echo $row['description'] ?>" data-amount="<?php echo $row['amount'] ?>">Edit</button>
                                       <button class="btn btn-sm btn-outline-danger delete_fees" type="button" data-id="<?php echo $row['id'] ?>">Archive</button>
                                            </td>
                                    </tr>
                                <?php endwhile; ?>
                            </tbody>
...
<div class="modal" id="manage_course" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
			...
			<button type="button" class="btn btn-dark" id="save_fee">Save</button>
